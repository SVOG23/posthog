...
export interface personalIntegrationsLogicValues {
    ...
    linkableSlackWorkspacesLoading: boolean
    slackConnect: boolean
    slackConnectLoading: boolean
    slackIntegrations: PersonalSlackIntegration[]
    slackIntegrationsLoading: boolean
    slackLinkEnabled: boolean
}
...
export interface personalIntegrationsLogicActions {
    ...
    connectGitHubFailure: () => {
        value: true
    }
    connectSlack: (payload?: { workspace?: LinkableSlackWorkspace }) => {
        workspace?: LinkableSlackWorkspace
    }
    connectSlackFailure: (
        error: string,
        errorObject?: any
    ...
    disconnectGitHub: (installationId: string) => {
        installationId: string
    }
    disconnectSlack: (slackUserId: string) => {
        slackUserId: string
    }
    ...
    loadLinkableSlackWorkspaces: () => any
    loadLinkableSlackWorkspacesFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
    ...
    loadLinkableSlackWorkspacesSuccess: (
        linkableSlackWorkspaces: LinkableSlackWorkspace[],
        payload?: any
    ) => {
        linkableSlackWorkspaces: LinkableSlackWorkspace[]
    ...
    loadSlackIntegrations: () => any
    loadSlackIntegrationsFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface personalIntegrationsLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        slackLinkEnabled: (featureFlags: FeatureFlagsSet) => boolean
    }
}

export type personalIntegrationsLogicType = MakeLogicType<
    personalIntegrationsLogicValues,
    personalIntegrationsLogicActions,
    Record<string, any>,
    personalIntegrationsLogicMeta
>
