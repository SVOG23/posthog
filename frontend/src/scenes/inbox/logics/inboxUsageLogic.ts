...
export interface inboxUsageLogicActions {
    ...
    resetLimitForm: (values?: { prs: number | null }) => {
        values?: {
            prs: number | null
        }
    }
    ...
    submitLimitFormRequest: (limitForm: { prs: number | null }) => {
        limitForm: {
            prs: number | null
        }
    }
    submitLimitFormSuccess: (limitForm: { prs: number | null }) => {
        limitForm: {
            prs: number | null
        }
    }
...
export type inboxUsageLogicType = MakeLogicType<
    inboxUsageLogicValues,
    inboxUsageLogicActions,
    Record<string, any>,
    inboxUsageLogicMeta
>
...
export const inboxUsageLogic = kea<inboxUsageLogicType>([
    ...
    selectors({
        ...
        usedPrsDisplay: [
            (s) => [s.usedPrs, s.limitPrs],
            (usedPrs: number, limitPrs: number | null): number =>
                limitPrs != null ? Math.min(usedPrs, limitPrs) : usedPrs,
        ],
