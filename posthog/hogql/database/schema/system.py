...
class SystemTables(TableNode):
    ...
    children: dict[str, TableNode] = {
        ...
        "support_ticket_tags": TableNode(name="support_ticket_tags", table=ticket_tagged_items),
        "support_ticket_assignments": TableNode(name="support_ticket_assignments", table=ticket_assignments),
        "support_ticket_roles": TableNode(name="support_ticket_roles", table=ticket_assignee_roles),
