...
# Shared by the `linkedin-ads` and `linkedin-pages` integration kinds: one registered LinkedIn app,
# two consent screens, because the advertising and Community Management scopes are separate products.
